...
SECRET_KEY = 'django-insecure-37)ww6j-xj7gr^6c6k(r=xm5ue5562bjnkgn7=9^**%@(b0ze#'
...
AUTH_USER_MODEL = 'myevent.UserModel'
...
ALLOWED_HOSTS = ['*']  # Replace with your actual Render app name
...
CSRF_TRUSTED_ORIGINS = ['https://myevent.onrender.com']
